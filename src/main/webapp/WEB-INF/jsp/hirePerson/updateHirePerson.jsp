    ...
    <div class="collapse navbar-collapse" id="navbarCollapse" style="margin-left: 100px;">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item navbar-background">
                <a class="nav-link" href="${pageContext.request.contextPath}/hirePerson/allMemberLimit?startIndex=1">
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/hirePerson/updateMember" method="post" id="hirePersonform" name="hirePersonform">
        <%-- 前端传递隐藏域 --%>
