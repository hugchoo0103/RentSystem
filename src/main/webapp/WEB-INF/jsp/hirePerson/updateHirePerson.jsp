...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
    <a class="navbar-brand" href="${pageContext.request.contextPath}/house/allHouseLimit?startIndex=1">X-Dance Studio</a>
...
<div class="container">
    <div class="text-center mb-4">
        <h1 class="h1 font-weight-normal" style="font-family: 华文细黑"><small>MODIFY hirePerson</small></h1>
    </div>

    <form action="${pageContext.request.contextPath}/hirePerson/updateHirePerson" method="post" id="hirePersonform" name="hirePersonform">
        <%-- 前端传递隐藏域 --%>
        <input type="hidden" name="hirePersonId" value="${upHirePerson.hirePersonId}">

        <div class="form-group">
            <label>房主姓名</label>
            <input type="text" class="form-control" name="userName" value="${upHirePerson.userName}" required>
        </div>
        <div class="form-group">
            <label>房主手机号</label>
            <input type="text" class="form-control" name="phone" value="${upHirePerson.phone}" required>
        </div>
        <div class="form-group">
            <label>房主性别</label>
            <c:if test="${upHirePerson.sex.equals('男')}">
                <select class="form-control choose_id" name="houseStatus" required>
                    <option value="0" selected="selected">男</option>
                    <option value="1">女</option>
                </select>
            </c:if>
            <c:if test="${upHirePerson.sex.equals('女') }">
                <select class="form-control choose_id" name="houseStatus" required>
        ...
        <div class="form-group">
            <label>email</label>
            <input type="text" class="form-control" name="email" value="${upHirePerson.email}">
        </div>
        <br>
        <center><button id="button" type="submit" class="btn add-button">修改</button></center>
    </form>
