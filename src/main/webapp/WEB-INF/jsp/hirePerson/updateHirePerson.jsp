...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
    <a class="navbar-brand" href="${pageContext.request.contextPath}/house/allHouseLimit?startIndex=1">X-Dance
        Studio</a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse" style="margin-left: 100px;">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item navbar-background">
                <a class="nav-link"
                   href="${pageContext.request.contextPath}/hirePerson/allHirePersonLimit?startIndex=1">
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/hirePerson/updateHirePerson" method="post" id="hirePersonform"
          name="hirePersonform">
        <%-- 前端传递隐藏域 --%>
        <input type="hidden" name="hireId" value="${upHirePerson.hireId}">
        ...
        <div class="form-group">
            <label>房主性别</label>
            <c:if test="${upHirePerson.sex=='male'}">
                <select class="form-control choose_id" name="sex" required>
                    <option value="male" selected="selected">男</option>
                    <option value="female">女</option>
                </select>
            </c:if>
            <c:if test="${upHirePerson.sex=='female' }">
                <select class="form-control choose_id" name="sex" required>
